...
public class RegistrationServiceImpl implements RegistrationService {
  ...
  @Autowired
  public RegistrationServiceImpl(final UserRepository repo, final UserInfoRepository infoRepo,
  ...
  public AppUser attemptRegisterUser(RegistrationForm form) {
    final ApplicationAuthority userAuthority = new ApplicationAuthority("ROLE_USER");
    final ApplicationAuthority[] newUserAuthoritiesValues = new ApplicationAuthority[] {
        userAuthority };
    final Set<ApplicationAuthority> newUserAuthorities = new HashSet<ApplicationAuthority>(
        Arrays.asList(newUserAuthoritiesValues));
